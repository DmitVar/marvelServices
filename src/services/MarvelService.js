...
const useMarvelService = () =>{
	...
	const _apiBase = 'https://gateway.marvel.com:443/v1/public/';//приватные переменные
	const _apiKey = 'apikey=7fe50572e938a2bd1c6e9597b8f88b5a';
	const _baseOffset = 0;
	...
	//функция получения одного персонажа по id
